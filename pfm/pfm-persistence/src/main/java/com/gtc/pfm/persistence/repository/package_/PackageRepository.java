 ...
 * 
 */
package com.gtc.pfm.persistence.repository.package_;
...
/**
 * This interface identifies all data access methods related with {@link Package} exposed to other layers and services
 * 
 * @author stanriku
 *
 */
public interface PackageRepository extends PfmRepositoryInft{
