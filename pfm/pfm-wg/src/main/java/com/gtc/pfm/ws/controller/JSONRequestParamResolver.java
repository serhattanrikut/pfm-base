...
public class JSONRequestParamResolver implements HandlerMethodArgumentResolver {
    ...
    MappingJackson2HttpMessageConverter mappingJacksonHttpMessageConverter = null;
    ...
    public void initJsonConverter() {
        ...
        synchronized (JSONRequestParamResolver.class) {
            if(mappingJacksonHttpMessageConverter == null){
                ...
                if(!found){
                    mappingJacksonHttpMessageConverter = new MappingJackson2HttpMessageConverter();
    ...
    protected JavaType getJavaType(Type type, Class<?> contextClass) {
        return (contextClass != null) ?
        	TypeFactory.defaultInstance().constructType(type, contextClass) :
